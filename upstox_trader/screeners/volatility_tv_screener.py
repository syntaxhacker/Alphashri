...
class VolatilityTVScreener:
    ...
    def get_high_volatility_stocks(self, args):
        ...
        console.print("[bold yellow]Screening for High Volatility Stocks...[/bold yellow]")
        ...
        try:
            ...
            query = (
                ...
                .where(
                    ...
                    col('Volatility.D') > args.min_volatility / 100,  # Convert % to decimal
    ...
    def display_results(self, df, title, score_col=None):
        ...
        for _, row in df.iterrows():
            ...
            if 'volatility_pct' in df.columns:
                row_data.append(f"{row['volatility_pct']:.1f}%")
            if 'relative_volume_10d_calc' in df.columns:
...
def main():
    ...
    parser.add_argument('--min-volatility', type=float, default=2.0, help='Minimum daily volatility percentage')
