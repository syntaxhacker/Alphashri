...
const meta: Meta<typeof Tree> = {
  ...
  component: Tree,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Hierarchical tree with expand/collapse. Use for file structures, category navigation, or nested watchlists. When not to use: for flat lists use List. Uses MUI Tree with theme tokens (no hardcoded colors)." } } },
};
