...
import { Stack, Title, Button } from "@/ui";
...
const meta: Meta<typeof Menu> = {
  ...
  component: Menu,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Dropdown menu with items and dividers. Use for row actions or context menus. When not to use: for single select use Select. Uses MUI Menu with theme tokens (no hardcoded colors)." } } },
};
