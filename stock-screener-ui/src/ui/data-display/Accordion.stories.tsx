...
const meta: Meta<typeof Accordion> = {
  ...
  component: Accordion,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Collapsible sections with header. Use for FAQs, grouped settings, or expandable rows. When not to use: for single collapse use Collapse. Uses MUI Accordion with theme tokens (no hardcoded colors)." } } },
};
