...
export function Group({
  ...
  direction, wrap, justify, align, gap, grow, preventGrowOverflow,
  ...rest
}: UIGroupProps & Record<string, unknown>) {
  void grow; void preventGrowOverflow;
  return (
    <MuiBox
