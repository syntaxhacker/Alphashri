...
const meta: Meta<typeof Flex> = {
  ...
  component: Flex,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Flexbox layout primitive with full flex props. Use when direction/wrap/gap control is needed beyond Group/Stack. When not to use: simple row use Group, column use Stack. Uses MUI Flex with theme tokens (no hardcoded colors)." } } },
};
