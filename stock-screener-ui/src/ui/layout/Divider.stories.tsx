...
const meta: Meta<typeof Divider> = {
  ...
  component: Divider,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Visual separator between sections. Use with label prop for titled dividers. When not to use: for spacing alone use Stack gap. Uses Mantine Divider with theme tokens (no hardcoded colors)." } } },
};
