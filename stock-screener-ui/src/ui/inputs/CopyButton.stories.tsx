...
const meta: Meta<typeof CopyButton> = {
  ...
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "One-click copy to clipboard with copied feedback. Use for copying symbols, IDs, or commands. When not to use: for general actions use Button. Uses MUI CopyButton with theme tokens (no hardcoded colors)." } } },
};
