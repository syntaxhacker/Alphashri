...
const meta: Meta<typeof ActionIcon> = {
  ...
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Icon-only button with variant and size. Use for toolbar actions, close buttons, or compact controls. When not to use: for text actions use Button. Uses MUI ActionIcon with theme tokens (no hardcoded colors)." } } },
};
