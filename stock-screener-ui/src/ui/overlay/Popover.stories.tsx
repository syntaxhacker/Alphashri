...
const meta: Meta<typeof Popover> = {
  ...
  component: Popover,
  tags: ["autodocs"],
  parameters: { docs: { description: { component: "Floating panel anchored to a trigger. Use for filters, pickers, or contextual menus. When not to use: for modal dialogs use Modal. Uses MUI Popover with theme tokens (no hardcoded colors)." } } },
};
