...
export function getInitialValues(props: {
  ...
  if (mode === "edit" && strategy) {
    return {
      ...
      near_high_threshold_pct: strategy.near_high_threshold_pct,
      min_days_since_52w_high: strategy.min_days_since_52w_high,
  ...
  if (template) {
    return {
      ...
      near_high_threshold_pct: template.near_high_threshold_pct,
      min_days_since_52w_high: template.min_days_since_52w_high,
