...
export function SectorPage() {
  return (
    <Box h="100%" style={{ display: "flex", flexDirection: "column" }} data-testid="sector-analysis-view">
      <Box flex="0 0 auto" style={{ padding: "var(--mantine-spacing-md)" }} className="sector-analysis-header">
        <Stack gap="md">
          <Group justify="space-between" align="flex-start">
            ...
            <Group gap="xs">
              ...
              <Anchor href={`${API_BASE}/sector/dashboard-modular.html`} target="_blank" rel="noreferrer">
                <Button leftSection={<IconExternalLink size={14} />} variant="filled" size="xs" radius="sm">
                  Open Fullscreen
                </Button>
              </Anchor>
            </Group>
          ...
          <Text size="xs" c="dimmed" style={{ fontStyle: "italic" }} className="sector-analysis-note">
            Optional: run <code>historical_sector_cycles/sector_contributors_api.py</code>{" "}
            for volume endpoints on <code>:5555</code>.
          </Text>
        </Stack>
      </Box>
