 ...
 */
function buildORBLine(candles: PreviewCandle[], orb_zones: ORBZone[], type: 'high' | 'low'): (number | null)[] {
  ...
  return [
    {
      ...
      tooltip: {
        show: true,
        formatter: (params: any) => params.value !== null ? `<span style="color:#EF5350">R1: ₹${params.value.toFixed(2)}</span>` : ''
      },
    },
    {
      id: 'pivot-pp',
      ...
      tooltip: {
        show: true,
        formatter: (params: any) => params.value !== null ? `<span style="color:#AB47BC">PP: ₹${params.value.toFixed(2)}</span>` : ''
      },
    },
    {
      id: 'pivot-s1',
      ...
      tooltip: {
        show: true,
        formatter: (params: any) => params.value !== null ? `<span style="color:#26A69A">S1: ₹${params.value.toFixed(2)}</span>` : ''
      },
    },
  ]
}
