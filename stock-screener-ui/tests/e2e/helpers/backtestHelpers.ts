...
export async function mockBacktestStrategies(
  page: Page,
...
export async function selectSymbolFromMultiselect(
  page: Page,
...
export async function withTradeHistoryPanel(page: Page, fn: () => Promise<void>) {
